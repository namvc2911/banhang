			...
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="beta-products-list">
						...
						<div class="row">
							@foreach($sanpham_tuongtu as $sp1)
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-body">
										<p class="single-item-title">{{$sp1->name}}</p>
										<p class="single-item-price">
											@if($sp1->promotion_price==0)
												<span class="flash-sale">{{number_format($sp1->unit_price)}}Đ</span>
									@else
												<span class="flash-del">{{number_format($sp1->unit_price)}} Đ</span>
												<span class="flash-sale">{{number_format($sp1->promotion_price)}} Đ</span>
									@endif
										</p>
									</div>
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="{{route('chitietsanpham',$new->id)}}"><i class="fa fa-shopping-cart"></i></a>
